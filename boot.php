...
rex_extension::register('PACKAGES_INCLUDED', static function () {
    ...
    $isAllowed = rex_extension::registerPoint(new rex_extension_point('YQE_IS_ALLOWED', ('index.php?page=yform/manager/data_edit' === rex_url::currentBackendPage())));

    if (rex::isBackend() && null !== rex::getUser() && $isAllowed) {
