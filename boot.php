...
if (\rex::isBackend() && \rex::getUser()) {
    \rex_view::setJsProperty('yqeClose', 0x100);
    \rex_view::setJsProperty('yqeReload', 0x101);
    \rex_view::setJsProperty('yqeShowLoading', 0x102);
    \rex_view::setJsProperty('yqeHideLoading', 0x103);
    \rex_view::setJsProperty('yqeResize', 0x104);
